...
const file_capabilities_blockchain_evm_v1alpha_client_proto_rawDesc = "" +
	...
	"\x11TX_STATUS_SUCCESS\x10\x022\xc3\x19\n" +
	...
	"\vWriteReport\x127.capabilities.blockchain.evm.v1alpha.WriteReportRequest\x1a5.capabilities.blockchain.evm.v1alpha.WriteReportReply\x1a\x88\x10\x82\xb5\x18\x83\x10\b\x01\x12\tevm@1.0.0\x1a\xf3\x0f\n" +
	"\rChainSelector\x12\xe1\x0f\x12\xde\x0f\n" +
	"\x17\n" +
