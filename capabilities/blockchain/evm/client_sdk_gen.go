...
func X_GeneratedCodeOnly_Wrap_WriteCreReportRequest(i *WriteReportRequest) (*WriteCreReportRequest, error) { //nolint
	...
	report, err := sdk.X_GeneratedCodeOnly_WrapReport(i.Report)
	if err != nil {
...
func (c *Client) WriteReport(runtime sdk.Runtime, input *WriteCreReportRequest) sdk.Promise[*WriteReportReply] {
	wrapped := &anypb.Any{}
