...
type ReadContractRequest struct {
	...
	Args       []*ScVal               `protobuf:"bytes,3,rep,name=args,proto3" json:"args,omitempty"` // Typed Soroban contract arguments (replaces raw XDR bytes)
...
func (x *ReadContractRequest) GetArgs() []*ScVal {
	if x != nil {
		return x.Args
	}
	return nil
...
var file_capabilities_blockchain_stellar_v1alpha_client_proto_goTypes = []any{
	...
	(*ScVal)(nil),                        // 8: capabilities.blockchain.stellar.v1alpha.ScVal
...
func file_capabilities_blockchain_stellar_v1alpha_client_proto_init() {
	...
	file_capabilities_blockchain_stellar_v1alpha_scval_proto_init()
