...
const file_capabilities_networking_confidentialhttp_v1alpha_client_proto_rawDesc = "" +
	...
	"\arequest\x18\x02 \x01(\v2=.capabilities.networking.confidentialhttp.v1alpha.HTTPRequestR\arequest2\xcc\x01\n" +
	"\x06Client\x12\x98\x01\n" +
	"\vSendRequest\x12I.capabilities.networking.confidentialhttp.v1alpha.ConfidentialHTTPRequest\x1a>.capabilities.networking.confidentialhttp.v1alpha.HTTPResponse\x1a'\x82\xb5\x18#\b\x01\x12\x1dconfidential-http@1.0.0-alpha \x01b\x06proto3"
