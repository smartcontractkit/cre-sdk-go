...
const file_capabilities_networking_http_v1alpha_client_proto_rawDesc = "" +
	...
	"\x11MultiHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12H\n" +
	"\x05value\x18\x02 \x01(\v22.capabilities.networking.http.v1alpha.HeaderValuesR\x05value:\x028\x012\x9a\x01\n" +
	"\x06Client\x12l\n" +
	"\vSendRequest\x12-.capabilities.networking.http.v1alpha.Request\x1a..capabilities.networking.http.v1alpha.Response\x1a\"\x82\xb5\x18\x1e\b\x02\x12\x18http-actions@1.0.0-alpha \x01b\x06proto3"
