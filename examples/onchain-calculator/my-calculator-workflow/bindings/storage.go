...
const StorageABI = `[{"inputs":[],"name":"get","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"}]`

func NewStorageAbi() abi.ABI {
	a, _ := abi.JSON(strings.NewReader(StorageABI))
	return a
}
