...
func (c *Consensus) Simple(runtime sdk.Runtime, input *pb2.SimpleConsensusInputs) sdk.Promise[*pb.Value] {
	...
	capCallResponse := sdk.Then(runtime.CallCapability(&sdkpb.CapabilityRequest{
...
func (c *Consensus) Report(runtime sdk.Runtime, input *pb2.ReportRequest) sdk.Promise[*sdk.Report] {
	wrapped := &anypb.Any{}
	err := anypb.MarshalFrom(wrapped, input, proto.MarshalOptions{Deterministic: true})
	if err != nil {
		return sdk.PromiseFromResult[*sdk.Report](nil, err)
	}
	capCallResponse := sdk.Then(runtime.CallCapability(&sdkpb.CapabilityRequest{
		Id:      "consensus@1.0.0-alpha",
		Payload: wrapped,
	...
	return sdk.Then(capCallResponse, sdk.X_GeneratedCodeOnly_WrapReport)
